...
--
-- Name: elements; Type: TABLE; Schema: public; Owner: db17
--
...
ALTER TABLE public.elements OWNER TO db17;

--
-- Name: properties; Type: TABLE; Schema: public; Owner: db17
--
...
ALTER TABLE public.properties OWNER TO db17;

--
-- Name: types; Type: TABLE; Schema: public; Owner: db17
--
...
ALTER TABLE public.types OWNER TO db17;

--
-- Name: types_type_id_seq; Type: SEQUENCE; Schema: public; Owner: db17
--
...
ALTER TABLE public.types_type_id_seq OWNER TO db17;

--
-- Name: types_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: db17
--
...
--
-- Name: types type_id; Type: DEFAULT; Schema: public; Owner: db17
--
...
--
-- Data for Name: elements; Type: TABLE DATA; Schema: public; Owner: db17
--
...
--
-- Data for Name: properties; Type: TABLE DATA; Schema: public; Owner: db17
--
...
--
-- Data for Name: types; Type: TABLE DATA; Schema: public; Owner: db17
--
...
--
-- Name: types_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: db17
--
...
--
-- Name: elements elements_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: elements elements_name_key; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: elements elements_pkey; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: elements elements_symbol_key; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: properties properties_atomic_number_key; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: properties properties_pkey; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: types types_pkey; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: properties properties_atomic_number_fkey; Type: FK CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: properties properties_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: db17
--
