...
--
-- Name: worldcup; Type: DATABASE; Schema: -; Owner: db17
--

CREATE DATABASE worldcup WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';


ALTER DATABASE worldcup OWNER TO db17;
...
--
-- Name: games; Type: TABLE; Schema: public; Owner: db17
--
...
ALTER TABLE public.games OWNER TO db17;

--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: db17
--
...
ALTER TABLE public.games_game_id_seq OWNER TO db17;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: db17
--
...
--
-- Name: teams; Type: TABLE; Schema: public; Owner: db17
--
...
ALTER TABLE public.teams OWNER TO db17;

--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: db17
--
...
ALTER TABLE public.teams_team_id_seq OWNER TO db17;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: db17
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: db17
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: db17
--
...
--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: db17
--
...
--
-- Data for Name: teams; Type: TABLE DATA; Schema: public; Owner: db17
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: db17
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: db17
--
...
--
-- Name: games games_pkey; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: teams teams_pkey; Type: CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: db17
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: db17
--
